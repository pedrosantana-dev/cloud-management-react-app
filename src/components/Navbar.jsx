    ...
    return (
        <div className='w-screen h-[80px] bg-zinc-200 fixed drop-shadow-lg z-10'>
            <div className="px-2 flex justify-between items-center w-full h-full">
                <div className='flex items-center'>
                    ...
                    <ul className="hidden md:flex">
                        ...
                        <li><Link to="about" smooth={true} offset={-200} duration={500}>Sobre</Link></li>
                        ...
                        <li><Link to="pricing" smooth={true} offset={-50} duration={500}>Preços</Link></li>
                    </ul>
                </div>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="about" smooth={true} offset={-200} duration={500}>Sobre</Link></li>
                ...
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="pricing" smooth={true} offset={-50} duration={500}>Preços</Link></li>
